...
{/* <div className="bg-teal-500 p-6 rounded-lg mb-5" style={{ backgroundColor: '#408dbc' }}>
  ...
  <div className="flex flex-col lg:flex-row lg:space-x-4 w-full gap-4">
    <div className="flex items-center bg-white rounded-lg overflow-hidden w-full lg:flex-1 relative">
      <span className="absolute left-2 top-1/2 transform -translate-y-1/2 lg:hidden">
        <img src={locationImage} alt="Location" className="w-6 h-6" />
      </span>
      <select
        value={city}
        onChange={handleCityChange}
        className="p-2 border-none outline-none bg-white w-full pl-10 lg:pl-2"
      >
      ...
      <span className="absolute right-2 top-1/2 transform -translate-y-1/2 hidden lg:block">
        <img src={locationImage} alt="Location" className="w-6 h-6" style={{ marginRight: "9px" }} />
      </span>
    </div>
    ...
    <div className="flex items-center bg-white rounded-lg overflow-hidden w-full lg:flex-1 relative">
      ...
      <input
        ...
        className="w-full p-2 border-none outline-none bg-white pl-10 lg:pl-2"
      />
      <span className="absolute right-2 top-1/2 transform -translate-y-1/2 hidden lg:block">
        <svg className="w-6 h-6 text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
    ...
    <button onClick={clearFilters} className="text-white underline">
      ...
      <div className="flex flex-wrap justify-between items-center w-full gap-4">
        ...
        <div className="flex items-center bg-white rounded-lg overflow-hidden">
            ...
            />
            <span>
              <img style={{marginLeft:"90px",cursor:'pointer'}} src={calenderImage} alt="Calendar" className="w-6 h-6 set-margin" onClick={() => document.querySelector('.react-datepicker__input-container input').focus()} />
            </span>
          </div>
