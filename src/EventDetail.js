            ...
            <div className='event_main-block'>
              <div className='div-block-17'>
                ...
                <div className='perdormer'>
                  ...
                  <a href={event.fieldData.tickets} style={{backgroundColor:'#408dbc',marginTop:'10px'}} className="inline-block bg-blue-500 text-white font-medium py-2 px-4 rounded hover:bg-blue-600 transition-colors">Buy Ticket</a>
                </div>
        ...
        <div className="flex mb-4">
          ...
          <div className="bg-white p-6  rounded-lg">
            <div className="flex justify-between items-center">
              ...
              <div className='flex'>
                <span className="text-lg font-semibold mr-4">Follow By:</span>
                <a href={event.fieldData['social-tw-link']} aria-label="Twitter" className="text-blue-500 hover:text-blue-600 mr-2">
                  <FaTwitter size={24} />
                </a>
                <a href={event.fieldData['social-fb-link']} aria-label="Facebook" className="text-blue-500 hover:text-blue-600 mr-2">
                  <FaFacebookF size={24} />
                </a>
                <a href={event.fieldData['social-wt-link']} aria-label="WhatsApp" className="text-green-500 hover:text-green-600 mr-2">
                  <FaWhatsapp size={24} />
                </a>
